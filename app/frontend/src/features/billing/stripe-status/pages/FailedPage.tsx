...
export default function FailedPage({
  ...
  return (
    ...
    >
      {/* Header inside the container box */}
      <div className="sticky top-0 w-full px-6 sm:px-10 py-5 border-b border-gray-100 flex items-center justify-between z-30 bg-white/90 backdrop-blur-md">
