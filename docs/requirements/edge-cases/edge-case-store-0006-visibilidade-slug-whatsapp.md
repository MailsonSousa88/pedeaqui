...
- loja sem WhatsApp válido recebe tentativa de checkout.
...
- gerar checkout sem destino válido no WhatsApp.
...
4. Impedir checkout quando o WhatsApp da loja não estiver válido.
...
- Checkout de loja sem WhatsApp válido deve ser bloqueado.
...
- se WhatsApp inválido desativa checkout ou a loja inteira.
