      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-sm leading-6 text-[#6b7280]">
            Configure um preço promocional e, se quiser, uma data de encerramento.
          </p>
        </div>
      </div>
        ...
        >
          ...
          <span className="flex flex-col gap-1">
            ...
            <span className="text-xs leading-5 text-[#6b7280]">
              Habilita o preço promocional e a data de encerramento opcional.
            </span>
          </span>
        </button>
      </div>
